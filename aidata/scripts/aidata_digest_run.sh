...
SOURCES="raven claude_jsonl multica_issue multica_run multica_comment claude_job github_repo github_pr pr_cache ado_pr state_db hermes_tools hermes_messages memory_claude memory_hermes_db memory_hermes_md news aidash_events local_git browser_history gecko"
