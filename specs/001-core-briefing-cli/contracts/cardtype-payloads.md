...
```json
{
  "title": "Atlas test suite is the bottleneck",
  "body": "Over the past week, 64% of CI time was spent in Atlas integration tests. Splitting these into a separate workflow would reduce average PR feedback time by ~40s.",
  "citations": [
    {"label": "PR #2104 timing", "url": "https://github.com/example/atlas/pull/2104/checks"},
    {"label": "Workflow runs", "url": "https://github.com/example/atlas/actions"}
  ]
}
```
...
{
  "items": [
    {"title": "Review Atlas PRs from Multica overnight", "priority": "high"},
  ...
  "sections": [
    {
      ...
      "paragraphs": ["Atlas merged 3 PRs overnight.", "The crash that was blocking v9 is fixed."]
    },
    {
