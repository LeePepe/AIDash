...
card --container-id "$C_KPI" --id "22222222-0000-0000-0000-000000000001" \
  ...
  --payload '{"items":[{"label":"PRs merged","value":12,"trend":"up","higherIsBetter":true,"context":"Atlas · this week","series":[4,6,5,8,7,10,9,12]}]}'
...
card --container-id "$C_KPI" --id "22222222-0000-0000-0000-000000000003" \
  ...
  --payload '{"items":[{"label":"Coverage","value":87,"unit":"%","ratio":0.87,"context":"Atlas"}]}'
...
card --container-id "$C_ADO" --id "33333333-0000-0000-0000-000000000002" \
  ...
  --payload '{"title":"Build-cache rework is paying off","subtitle":"Atlas CI · this week","body":"Median CI dropped from 180s to 124s over the week — the single biggest developer-time win this sprint. Consider extending the same cache strategy to the integration suite."}'
