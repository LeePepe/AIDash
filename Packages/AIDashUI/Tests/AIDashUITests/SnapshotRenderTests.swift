...
struct SnapshotRenderTests {
    ...
    func renderSample() {
        ...
        let unified = container("Today", .grid, [
            ...
            card(.digest, .wide, .neutral, #"{"title":"A strong, incident-light day","subtitle":"All repos · yesterday","body":"Twelve PRs merged across Atlas and Basalt, with the v9-blocking crash finally resolved. Build times are trending down.","sections":[{"heading":"Shipped","paragraphs":["ABC-301 crash fix.","Cache rework cut CI 30%."]},{"heading":"Blocking","paragraphs":["Perf review due 5pm."]}]}"#),
